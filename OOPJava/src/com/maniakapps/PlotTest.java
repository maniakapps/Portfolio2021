...
public class PlotTest {
    ...
    public void testOverlaps4() {
        assertFalse(plot1.overlaps(plot9)); //plot9 overlaps the left side of plot1
    ...
    public void testEncompasses1() {
        ...
        assertTrue(plot1.encompasses(plot12)); //plot6 overlaps the right side of plot1
